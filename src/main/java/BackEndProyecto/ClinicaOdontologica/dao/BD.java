...
public class BD {
    ...
    private static final String SQL_DROP_CREATE_TURNOS="DROP TABLE IF EXISTS TURNOS; " +
            "CREATE TABLE TURNOS (ID INT AUTO_INCREMENT PRIMARY KEY, PACIENTE_ID INT NOT NULL, ODONTOLOGO_ID INT NOT NULL, FECHA_TURNO DATE NOT NULL)";
    private static final String SQL_PRUEBA="INSERT INTO PACIENTES (NOMBRE, APELLIDO, CEDULA, FECHA_INGRESO, DOMICILIO_ID, EMAIL) VALUES('Jorgito','Pereyra','123456','2024-05-15',1,'jorge.pereyra@digitalhouse.com'),('Claudia','Heredia','11111111','2024-05-10',2,'claudia@claudia.com'); " +
            ...
            "INSERT INTO TURNOS (PACIENTE_ID, ODONTOLOGO_ID, FECHA_TURNO) VALUES ('1', '1', '2025-03-12'),('2', '2', '2021-12-12')";
